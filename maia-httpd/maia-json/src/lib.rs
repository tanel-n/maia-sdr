...
pub struct Ad9361 {
    ...
    /// Transmit gain in dB.
    pub tx_gain: f64,
    /// Transmit tone generator control.
    pub tx_tone_enabled: bool,
    /// Loopback mode.
    pub loopback_mode: Ad9361LoopbackMode,
}
...
pub struct PatchAd9361 {
    ...
    /// Transmit tone generator control.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tx_tone_enabled: Option<bool>,
    /// Loopback mode.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub loopback_mode: Option<Ad9361LoopbackMode>,
}
...
/// AD9361 loopback modes.
pub enum Ad9361LoopbackMode {
    /// Loopback disabled. Output is transmitted normally.
    Disabled = 0,
    /// Digital loopback. Transmitter output is looped back to receiver digitally.
    Digital = 1,
    /// RF loopback. Transmitter output is looped back to receiver after RF mixer.
    Rf = 2,
}

impl Default for Ad9361LoopbackMode {
    fn default() -> Self {
        Ad9361LoopbackMode::Disabled
    }
}
...
impl_str_conv!(Ad9361LoopbackMode,
               "Disabled" => Disabled,
               "Digital" => Digital,
               "RF" => Rf);
