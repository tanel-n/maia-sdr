...
ui_elements! {
    ...
    tx_tab: HtmlButtonElement => Rc<HtmlButtonElement>,
    ...
    tx_panel: HtmlElement => Rc<HtmlElement>,
    ...
    ad9361_tx_rf_bandwidth: HtmlInputElement => NumberInput<u32, input::MHzPresentation>,
    ad9361_tx_gain: HtmlInputElement => NumberInput<f64>,
    ad9361_loopback_mode: HtmlSelectElement => EnumInput<maia_json::Ad9361LoopbackMode>,
    ad9361_tx_tone_enabled: HtmlInputElement => CheckboxInput,
...
impl Ui {
    ...
    fn set_callbacks(&self) -> Result<(), JsValue> {
        ...
        set_on!(
            ...
            ad9361_tx_rf_bandwidth,
            ad9361_tx_gain,
            ad9361_loopback_mode,
            ad9361_tx_tone_enabled,
            ddc_frequency,
            spectrometer_input,
...
impl Ui {
    ...
    impl_tabs!(recording, ddc, waterfall, geolocation, tx, other);
}
